...
export default function GitHubConnectCard({ onImported }) {
    ...
    if (loading) {
        return (
            <GlassCard>
                ...
                <p className="font-semibold text-white">Checking GitHub connection...</p>
            </GlassCard>
        );
    }
    ...
    return (
        <div className="space-y-6">
            <GlassCard className="relative overflow-hidden">
                <div className="absolute -right-16 -top-16 h-48 w-48 rounded-full bg-pink-500/14 blur-3xl" />
                <div className="absolute -bottom-20 left-10 h-48 w-48 rounded-full bg-orange-500/10 blur-3xl" />

                <div className="relative">
                    <div className="mb-5 flex items-start justify-between gap-4">
                        <div>
                            <p className="text-sm text-pink-300">GitHub Integration</p>
                    ...
                    {github?.connected ? (
                        ...
                        <>
                            <p className="text-sm leading-7 text-[#cfc3dd]">
                                Connect your GitHub account so DevOrbit can fetch repositories
                                and convert selected repos into project systems.
                            </p>
            ...
            {github?.connected && <GitHubRepoImporter onImported={onImported} />}
        </div>
    );
}