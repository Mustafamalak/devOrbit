    ...
    <header className="sticky top-0 z-30 mb-6 border-b border-white/10 bg-[#0b0614]/60 px-4 py-4 backdrop-blur-2xl lg:rounded-b-3xl lg:border lg:border-white/10">
      <div className="flex items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-3 lg:hidden">
          <div className="grid h-10 w-10 place-items-center rounded-2xl bg-linear-to-br from-pink-400 via-orange-400 to-violet-600 text-white">
            <Sparkles size={20} />
          </div>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <button className="relative grid h-11 w-11 place-items-center rounded-2xl border border-white/10 bg-white/5 text-[#a89bb8] transition hover:border-pink-300/30 hover:text-pink-200">
            <Bell size={18} />
          ...
          <div className="hidden items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-2 sm:flex">
            <div className="grid h-8 w-8 place-items-center rounded-xl bg-linear-to-br from-pink-400 via-orange-400 to-violet-600 text-sm font-black text-white">
              M
            </div>
            <div>
              <p className="text-sm font-semibold text-white">Mustafa</p>
              <p className="text-xs text-[#a89bb8]">Frontend Commander</p>
            </div>
          </div>
        </div>
      </div>
