  ...
  return (
    <header className="sticky top-0 z-30 mb-6 border-b border-white/10 bg-slate-950/55 px-4 py-4 backdrop-blur-2xl lg:rounded-b-3xl lg:border lg:border-white/10">
      <div className="flex items-center justify-between gap-4">
        ...
        <button className="grid h-10 w-10 place-items-center rounded-2xl border border-white/10 bg-white/5 text-slate-300 lg:hidden">
          <Menu size={20} />
        </button>

        <div className="hidden flex-1 items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-slate-400 lg:flex">
          <Search size={18} />
          <input
