    ...
    <GlassCard className="relative overflow-hidden">
      ...
      <div className="relative mb-7">
        ...
        <p className="mt-2 text-sm text-[#a89bb8]">
          A chronological stream of commits, issues, pull requests, reviews, and
          deployments.
        </p>
      </div>
            ...
            >
              ...
              <div className="group rounded-3xl border border-white/10 bg-white/[0.04] p-5 transition hover:border-pink-300/30 hover:bg-white/[0.075]">
                <div className="flex flex-col justify-between gap-3 md:flex-row md:items-start">
                  ...
                  <span
                    className={`inline-flex w-fit items-center gap-2 rounded-full border px-3 py-1 text-xs font-semibold ${statusStyles[item.status]
                      }`}
                  >
