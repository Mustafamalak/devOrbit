  ...
  return (
    <div className="pb-10">
      <section className="mb-7">
        <p className="text-sm font-medium text-cyan-300">Task Radar</p>
        ...
        <div className="mt-2 flex flex-col justify-between gap-4 xl:flex-row xl:items-end">
          ...
          <div className="rounded-2xl border border-purple-400/20 bg-purple-400/10 px-4 py-3 text-sm text-purple-200">
