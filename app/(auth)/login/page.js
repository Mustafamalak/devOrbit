...
export default function LoginPage() {
    ...
    return (
        <AuthShell
            eyebrow="Enter command mode"
            title="Welcome back, commander"
            description="Login to continue tracking your projects, sprint health, GitHub activity, and AI-generated developer insights."
        >
            <form
            ...
            >
                <div className="mb-6">
                    ...
                    <p className="mt-2 text-sm text-[#a89bb8]">
                        Access your personalized DevOrbit command center.
                    </p>
                </div>
                ...
                <p className="mt-5 text-center text-sm text-[#a89bb8]">
                    New to DevOrbit?{" "}
                    <Link href="/signup" className="font-semibold text-pink-300 hover:text-pink-200">
                        Create account
                    </Link>
                </p>
            </form>
